...
type RunRes = undefined | string[] | string;

export abstract class BaseAction<T extends ChatFasade, Task extends TaskTracker, Res = RunRes> {
    ...
    abstract run(data): Promise<Res | boolean>;
}
